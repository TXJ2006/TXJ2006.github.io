...
In deep networks the central object is not a single $W$, but the *inputâ€“output Jacobian*
...
where $q\_{\star}$ is the stationary pre-activation variance (derived in Â§9.5).
...
The moment method parallels Â§9.2: one expands
