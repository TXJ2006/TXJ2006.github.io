...
layout: "single"
url: "/notes/"
summary: "Research notes and mathematical reading program"
draft: false
ShowToc: true
TocOpen: true
hideMeta: true
...
This page brings the two parts of the original site together: a long-term mathematical reading program and a growing collection of typeset research notes. The PDFs are built from the LaTeX sources maintained in the [ElegantBook notes repository](https://github.com/TXJ2006/elegantbook-tech-blog).

## Research Notes

### Foundations of Sequential Decisions
...
5. **[Martingales and Optional Stopping](/files/notes/martingales-optional-stopping.pdf)**<br>
   Martingale tools for adaptive processes and stopping-time arguments.

6. **[KL Divergence as Statistical Evidence](/files/notes/kl-divergence-statistical-evidence.pdf)**<br>
   Relative entropy, likelihood ratios, and evidence accumulation.

### Models and Lower Bounds

7. **[Exponential Families as Bandit Models](/files/notes/exponential-families-bandit-models.pdf)**<br>
   Canonical parameters, sufficient statistics, and information geometry.

8. **[Change of Measure and Bandit Lower Bounds](/files/notes/change-of-measure-bandit-lower-bounds.pdf)**<br>
   Alternative environments, indistinguishability, and information-theoretic lower bounds.

## Mathematical Reading Program

The original reading map remains part of the site because it records the mathematical foundations behind the current research direction.

### Stage I · Foundations and Mathematical Thinking

- Richard Courant and Herbert Robbins, *What Is Mathematics?* — [archived PDF note](/files/what-is-mathematics.pdf)
...
### Stage IV · Graduate Analysis, Geometry, and Algebra
